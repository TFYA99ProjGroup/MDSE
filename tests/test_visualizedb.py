...
def mock_config_data():
    ...
    data = {"data" : {"data_source" : "json", "path" : "temp_path"},
            "plots" : {"plot_1" : {"type" : "doping", "average" : True, "fix_y" : True},
                       "plot_2" : {"type" : "scatter", "x" : "temperature", "y" : "MSD", "z" : "Lindeman"},
                        "plot_3" : {"type" : "ALL_PLOT", "x" : "temperature", "y" : "MSD", "z" : "Lindeman"},
                         "plot_4" : {"type" : "scatter", "x" : "speed_per_kelvin", "y" : "MSD", "z" : "Lindeman"} }}
...
def test_run_visualize(monkeypatch, mock_config_data, mock_sim_data):
    ...
    And generates plots.
    Data had 4 plots, 2 which are invalid format. Check so only 2 gets created.
    """
    ...
    assert(dummy_savefig.call_count == 2)
